...
/*
  ...
  pkg/reconciler/instances/kpack/actions/interceptors/service.go, the only
  modification being making the kube client a public field.

  This interceptor works by chance during kpack upgrade, however more
  kpack-specific interceptors may need to be implemented in future
*/
